  ...
  return (
    <section className="bg-[linear-gradient(135deg,#EBF6FC_0%,#FDFAF2_100%)] px-6 py-24 text-center md:px-10 lg:px-[60px]">
      <div className="mx-auto max-w-[760px]">
        <p className="text-[11px] font-bold uppercase tracking-[0.34em] text-[#4B9CC0]">Begin Today</p>
        ...
        <div className="mt-10">
          <LinkButton
            ...
            size="lg"
            className="inline-flex gap-2 rounded-full bg-[#7BC4E2] px-9 py-3 text-[12px] font-bold uppercase tracking-[0.18em] text-white shadow-[0_4px_18px_rgba(123,196,226,0.45)] transition hover:-translate-y-0.5 hover:bg-[#4B9CC0]"
          >
